...
```
We see that as the true value of mu increases after 3, the mean estimated value of mu for when the null was rejected diverges further (is smaller) from the true value of mu. 
